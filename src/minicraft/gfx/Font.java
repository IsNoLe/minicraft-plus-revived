...
public class Font {
	...
	private static String chars =
            ...
            "6789.,!?'"-+=/%()<>:;^@ÁÉÍÓÚÑ¿¡"+
            "ÃÊÇÔÕĞÇÜİÖŞÆØÅБГДЖЗИЙЛПУФХЦЧШЩЪ Ь" + 
            "ЭЮЯЫАВЕКМНОРСТ";	/* The order of the letters in the chars string is represented in the order that they appear in the sprite-sheet. */
